...
const baseStore = persisted('reservationTableState', defaultState, { storage: 'session' });

// Wrap it with update functions
export const reservationTableStore = {
  ...
  reset: () => {
    sessionStorage.removeItem('reservationTableState');
